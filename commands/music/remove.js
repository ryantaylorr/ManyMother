...
const queue = useQueue(inter.guild);
        ...
        if (track) {
            ...
            BaseEmbed.setAuthor({name: `removed ${track_to_remove.title} from my memory ✅` })
        ...
        if (number) {
            ...
            if (!trackname) return inter.editReply({ content: `I cannot conjure this track ${inter.member}...  try again ?❌`, ephemeral: true });   

            queue.removeTrack(index);

            BaseEmbed.setAuthor({name: `removed ${trackname} from my memory ✅` })
