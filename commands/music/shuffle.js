...
const queue = useQueue(inter.guild);
        ...
        if (!queue || !queue.isPlaying()) return inter.editReply({ content: `I am not conjuring anything ${inter.member}... try again ? ❌`, ephemeral: true });
        ...
        .setColor('#2f3136')
        .setAuthor({name: `I have rearanged the current ${queue.tracks.size} song(s) in my mind. ✅` })
